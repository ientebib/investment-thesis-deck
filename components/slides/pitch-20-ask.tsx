...
export function PitchSlide20Ask() {
  return (
    <>
      <SectionHeader sectionLabel="THE ASK" title="" subtitle="" />
      <div className="pitch-ask-wrap">
        ...
        <div className="pitch-ask-closing">
          The physical layer where fiscal dominance and AI infrastructure
          intersect offers durable, asymmetric returns
        </div>
      </div>
    </>
  );
